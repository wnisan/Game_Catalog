    ...
    >
      <div className="game-card__cover">
        {playTrailer && game.trailerVideoId ? (
          ...
          <>
            {getCoverUrl() ? (
              ...
              <div
                className="game-card__no-cover"
                aria-label="Нет изображения обложки"
              >
                Нет изображения
              </div>
            )}
        ...
        {isAuthenticated && (
          <button
            ...
            aria-label={
              isFavorited
                ? `Убрать ${game.name} из избранного`
                : `Добавить ${game.name} в избранное`
            }
      ...
      <div className="game-card__info">
        ...
        <div
          ...
          aria-label={`Rating: ${formatRating(game.rating)}`}
        >
