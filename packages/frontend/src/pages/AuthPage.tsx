        ...
        <div className="auth-page">
            <div className="auth-page__container">
                ...
                <div className="auth-page__card">
                    <div className="auth-page__tabs" role="tablist" aria-label="Режим входа">
                        <button
                            type="button"
                    ...
                    >
                        ...
                        <div className="auth-page__form-group">
                            ...
                            <div className="auth-page__input-wrapper">
                                <input
                                    ...
                                    disabled={isLoading}
                                    aria-required="true"
                                    aria-invalid={errorField === 'password' ? 'true' : 'false'}
                            ...
                            <div className="auth-page__form-group">
                                ...
                                <div className="auth-page__input-wrapper">
                                    <input
                                        ...
                                        disabled={isLoading}
                                        aria-required="true"
                                        aria-invalid={errorField === 'confirm' ? 'true' : 'false'}
                                        aria-describedby={errorField === 'confirm' ? 'confirm-password-error' : undefined}
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            aria-label={mode === 'login' ? 'Войти в аккаунт' : 'Создать новый аккаунт'}
                        >
                            {isLoading ? (
                                'Загрузка...'
                            ) : mode === 'login' ? (
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            aria-label="Вход через аккаунт Google"
                        >
