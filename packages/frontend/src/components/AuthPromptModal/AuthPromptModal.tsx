...
const AuthPromptModal = ({ onClose, message = 'Создайте аккаунт или войдите, чтобы продолжить.' }: AuthPromptModalProps) => {
        ...
        <div className="auth-prompt__overlay" onClick={onClose}>
            <div className="auth-prompt__modal" onClick={e => e.stopPropagation()}>
                ...
                <div className="auth-prompt__btns">
                    <button className="auth-prompt__primary" onClick={() => navigate('/auth')}>
                        Вход / Регистрация
                    </button>
