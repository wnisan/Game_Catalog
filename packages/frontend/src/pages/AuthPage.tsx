          ...
          >
            {mode === 'register' && (
              <div className="auth-page__form-group">
                ...
                <input
                  ...
                  aria-describedby={
                    errorField === 'name' ? 'name-error' : undefined
                  }
                />
              </div>
            )}
            ...
            <div className="auth-page__form-group">
              ...
              <input
                ...
                aria-describedby={
                  errorField === 'email' ? 'email-error' : undefined
                }
                autoComplete="email"
              />
            </div>
            ...
            <div className="auth-page__form-group">
              ...
              <div className="auth-page__input-wrapper">
                <input
                  ...
                  aria-describedby={
                    errorField === 'password' ? 'password-error' : undefined
                  }
                  autoComplete={
            ...
            <button
              ...
              disabled={isLoading}
              aria-label={
                mode === 'login' ? 'Войти в аккаунт' : 'Создать новый аккаунт'
              }
            >
              {isLoading
                ? 'Загрузка...'
