...
const GameCard = ({ game, onClick, onFavoriteChange, isFirst = false }: GameCardProps) => {
    ...
    const formatRating = (rating?: number): string => {
        return rating ? `${Math.round(rating)}/100` : 'У этой игры пока нет рейтинга.';
    };
        ...
        >
            <div className="game-card__cover">
                {playTrailer && game.trailerVideoId ? (
                    ...
                    <>
                        {getCoverUrl() ? (
                            ...
                            <div className="game-card__no-cover" aria-label="Нет изображения обложки">
                                Нет изображения
                            </div>
                        )}
                ...
                {isAuthenticated && (
                    <button
                        ...
                        disabled={isLoading}
                        aria-label={isFavorited ? `Убрать ${game.name} из избранного` : `Добавить ${game.name} в избранное`}
            ...
            <div className="game-card__info">
                ...
                {filteredGenres.length > 0 && (
                    <div className="game-card__genres" role="list" aria-label="Жанры">
